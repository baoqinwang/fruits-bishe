...
//    public static String day_Time = FastDateFormat.getInstance("yyyy-MM-dd HH:mm:ss").format(new Date());
     ...
     * 得到当前时间之前/之后的时间点
     */
    public static String day_MINUTE_back(int i) {
        Calendar calendar = Calendar.getInstance();
...
//    }
     ...
     */
      ...
      * @return
      */
      public static String getyyyyMMddDateString(String time) {
    	  String res;
...
//    	getyyyyMMddDateString(1523238570+"");
//    	 SimpleDateFormat format =  new SimpleDateFormat("yyyyMMdd");  
//    	 format.format(1523238570).par
////    	    Long time=new Long(1523238570);  
...
//        String time="0230";
//        int ho=Integer.parseInt(time.substring(0, 2))*60+Integer.parseInt(time.substring(2, 4));
//        System.out.println(ho);
        String urgeTimes="0002";
    	int min = Integer.parseInt(urgeTimes.substring(0, 2)) * 60
				+ Integer.parseInt(urgeTimes.substring(2, 4));
		Calendar calendar = Calendar.getInstance();
