//服务层
app.service('stockinfoPoiService',function($http){
    ...
    this.search=function(page,rows,searchEntity){
        return $http.post('../stockinfo/searchPoi.do?page='+page+"&rows="+rows+"&stockCount="+searchEntity.stockCount+"&fid="+searchEntity.fid+"&sid="+searchEntity.sid);
    }
